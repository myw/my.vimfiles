" Author: Misha Wolfson github.com/myw01
" Description: Lints fish files using fish -n, -d. Based on original by Niraj Thapaliya - https://github.com/nthapaliya

function! ale_linters#fish#fish_debug#Handle(buffer, lines) abort
    ...
    "
    " Uses the -d flag to make fish syntax checking more robust                                                           ^
    "
...
\   'executable': 'fish',
\   'command': 'fish -d -n %t',
\   'callback': 'ale_linters#fish#fish_debug#Handle',
\})
