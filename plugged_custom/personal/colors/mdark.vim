...
" Current Line
if exists('mdark_current_line') && mdark_current_line == 1 && has("gui_running")
	set cursorline
	call s:Color('CursorLine',  {'guibg': s:line_col})
endif
if exists('mdark_current_col') && mdark_current_col == 1 && has("gui_running")
	set cursorcolumn
...
" Search
call s:Color('Search', {'guifg': s:d_gray, 'guibg': s:l_orange, 'term': 'NONE', 'cterm': 'NONE', 'ctermfg': 'Blue', 'ctermbg': 'Brown'})
call s:Color('IncSearch', {'guifg': s:l_orange, 'guibg': s:d_gray, 'term': 'NONE', 'cterm': 'NONE', 'ctermfg': 'Green', 'ctermbg': 'Brown'})
...
call s:Color('LineNr', {'guifg': s:line_nr, 'guibg': s:black, 'ctermfg': 'DarkYellow'})
...
" Folds
call s:Color('Folded', {'guifg': s:fg, 'guibg': s:od_dusty_blue})
call s:Color('FoldColumn', {'guifg': s:d_dusty_blue, 'guibg': s:black})

" Specials
call s:Color('Title', {'guifg': s:l_orange, 'ctermfg': 'Yellow'})
...
" Syntax
call s:Color('Comment', {'guifg': s:l_green, 'gui': 'italic', 'ctermfg': 'DarkGreen'})

" Constants
call s:Color('Constant', {'guifg': s:green, 'ctermfg': 'Green'})
call s:Color('Character', {'guifg': s:pink, 'ctermfg': 'DarkRed'})
call s:Color('String', {'guifg': s:l_pink, 'ctermfg': 'DarkRed'})
call s:Color('Number', {'guifg': s:d_green, 'ctermfg': 'Green'})
call s:Color('Float', {'guifg': s:b_green, 'ctermfg': 'Green'})
call s:Color('Boolean', {'guifg': s:olive, 'ctermfg': 'Green'})

" Identifiers
call s:Color('Identifier', {'guifg': s:l_purple, 'ctermfg': 'DarkCyan'})
call s:Color('Function', {'guifg': s:dusty_blue, 'gui': 'bold', 'ctermfg': 'Cyan'})

" Statements
call s:Color('Statement', {'guifg': s:blue, 'gui': 'none', 'ctermfg': 'Blue'})
call s:Color('Conditional', {'guifg': s:b_blue, 'ctermfg': 'Blue'})
call s:Color('Repeat', {'guifg': s:vb_blue, 'ctermfg': 'Blue'})
call s:Color('Label', {'guifg': s:blue_lav, 'ctermfg': 'Blue'})
call s:Color('Operator', {'guifg': s:purple, 'ctermfg': 'DarkMagenta'})
call s:Color('Keyword', {'guifg': s:blue, 'ctermfg': 'Blue'})
call s:Color('Exception', {'guifg': s:l_blue, 'ctermfg': 'Blue'})

" Types
call s:Color('Type', {'guifg': s:d_dusty_blue, 'ctermfg': 'DarkBlue' })
call s:Color('StorageClass', {'guifg': s:d_dusty_blue, 'ctermfg': 'DarkBlue'  })
call s:Color('Structure', {'guifg': s:dg_dusty_blue, 'gui':'bold', 'ctermfg': 'DarkBlue'  })
call s:Color('Typedef', {'guifg': s:lg_dusty_blue, 'gui':'bold', 'ctermfg': 'DarkBlue' })

" Preprocs
call s:Color('Preproc', {'guifg': s:yellow, 'ctermfg': 'Yellow'})
call s:Color('Include', {'guifg': s:brown_orange, 'ctermfg': 'Yellow'})
call s:Color('Define', {'guifg': s:yellow_orange, 'ctermfg': 'Yellow'})
call s:Color('Macro', {'guifg': s:o_yellow, 'ctermfg': 'Yellow'})
call s:Color('PreCondit', {'guifg': s:l_orange, 'ctermfg': 'Yellow'})

" Specials
call s:Color('Special', {'guifg': s:white, 'ctermfg': 'White'})
call s:Color('SpecialChar', {'guifg': s:pink})
call s:Color('Tag', {'guifg': s:l_red})
call s:Color('Delimiter', {'guifg': s:l_lavender, 'ctermfg': 'DarkMagenta'})
call s:Color('SpecialComment', {'guifg': s:orange})
call s:Color('Debug', {'guifg': s:l_yellow})

" Misc
call s:Color('Underlined', {'guifg': s:magenta, 'term': 'underline', 'ctermfg': 'Magenta'})
call s:Color('Ignore', {'guifg': s:m_gray, 'ctermfg': 'Gray'})
